...
// Widget flyFijkPanelBuilder(FijkPlayer player, FijkData data,
...
//   List<double> speedList = [1.0,1.2,1.5,2.0];
//   int speedIndex = 0;
//   double _volume = 1.0;
//
...
//                 widget.player.setSpeed(speedList[speedIndex]);
//                 _startHideTimer();
//               },
//               child: Padding(
//                 padding: EdgeInsets.only(left: 10.0, right: 10.0),
//                 child: Text('${speedList[speedIndex]}x',style: TextStyle(
//                   fontSize: 14.0,
