...
class DetailInfo{
  ...
  DetailInfo.mjt(){
    info = [
      ...
      ReceivedMessageScreen(message: "2022年，即将本科毕业的我，希望有更多技术爱好者能够参与建设矿小助。于是，矿小助开源啦！（欢迎Star✨～）",linkModel: AboutLinkModel("https://github.com/cnatom/FlyingKxz","FlyingKxz-矿小助源代码","矿小助——矿大人自己的APP｜iOS&Android跨平台应用"),),
