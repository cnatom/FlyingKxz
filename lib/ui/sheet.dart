...
/// [Scaffold.bottomSheet], and a modal bottom sheet with [showFlyModalBottomSheet].
///
/// See also:
///
///  * [showBottomSheet] and [ScaffoldState.showBottomSheet], for showing
///    non-modal "persistent" bottom sheets.
///  * [showFlyModalBottomSheet], which can be used to display a modal bottom
///    sheet.
...
class BottomSheet extends StatefulWidget {
  ...
  /// [showFlyModalBottomSheet], for modal bottom sheets.
  const BottomSheet({
    Key? key,
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
  ...
  late final bool isScrollControlled;
  final Color? backgroundColor;
  final double? elevation;
  final ShapeBorder? shape;
  final Clip? clipBehavior;
  ...
  @override
  late final String? barrierLabel;
...
Future<T?> showFlyModalBottomSheet<T>({
...
/// [showFlyModalBottomSheet] function.
///
